import { Transfer as TransferEvent } from "../generated/Hashmask/Hashmask"; // Import the Transfer event from the Uniswap contract ABI
...
export function handleTransfer(event: TransferEvent): void {
  ...
  fromAccount.totalSent = fromAccount.totalSent.plus(event.params.tokenId);
  toAccount.totalReceived = toAccount.totalReceived.plus(event.params.tokenId);
